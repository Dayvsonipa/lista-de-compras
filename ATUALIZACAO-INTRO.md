# Atualização — Tela de abertura

Esta versão inclui uma tela de abertura leve para o Lista de Casa.
...
- Desativa os movimentos quando essa preferência estiver configurada no aparelho.
...
Substitua os arquivos do repositório pelos desta versão, faça o commit no GitHub Desktop e envie para o GitHub. A Vercel fará uma nova publicação automaticamente.
